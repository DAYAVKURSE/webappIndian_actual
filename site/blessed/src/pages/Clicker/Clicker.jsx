    ...
    <div className={styles.clicker__container}>
      <div className={styles.banner}>
        ...
        <div className={styles.banner__content}>
          <h1>Join Now!</h1>
          <p>Make a minimum deposit to participate in the giveaway of 3 Ducati motorbikes!</p>
          <p>Don't miss your chance!</p>
        </div>
        <img className={styles.banner__img} src={'./banner.png'}></img>
      </div>
      <div className={styles.games}>
              ...
              <div className={styles.game__title}>
                <div>
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M5.72058 0.595156C5.83165 0.358525 6.16822 0.358525 6.27928 0.595156L7.85402 3.95009L11.4063 4.49285C11.6546 4.53079 11.756 4.83364 11.5806 5.01342L8.9999 7.65839L9.60579 11.3728C9.64726 11.627 9.37737 11.8172 9.15192 11.6926L5.99993 9.95016L2.84781 11.6926C2.62236 11.8172 2.35247 11.627 2.39395 11.3728L2.99996 7.65839L0.419385 5.01341C0.243981 4.83363 0.345365 4.53079 0.593656 4.49285L4.14585 3.95009L5.72058 0.595156Z"
                      fill="#E1E1E1"
                    />
                  </svg>
            ...
            <NavLink to={'/games/roulette'}>
              ...
              <div className={styles.game__title}>
                <div>
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M5.64636 6.81559C5.61101 6.8034 5.57644 6.78956 5.54291 6.77396L3.51175 8.74917C4.11915 9.24266 4.85817 9.54033 5.64636 9.60901V6.81559Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M9.87195 6.18723H6.99945C6.98691 6.2216 6.97268 6.25522 6.95663 6.28782L8.98777 8.26302C9.49523 7.67233 9.80133 6.95368 9.87195 6.18723Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M6.45675 6.77396C6.42322 6.78958 6.38865 6.8034 6.3533 6.81559V9.60898C7.14146 9.54033 7.88046 9.24268 8.48788 8.74915L6.45675 6.77396Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M6.96504 0.0749633C6.32762 -0.0245813 5.65929 -0.0277436 4.98883 0.0820671L5.99378 1.96846L6.96504 0.0749633Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M3.01188 8.26304L5.04303 6.28782C5.02694 6.25522 5.01275 6.2216 5.00022 6.18723H2.12772C2.19832 6.95368 2.50439 7.67228 3.01188 8.26304Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M5.04306 5.39911L3.0119 3.42392C2.50442 4.01459 2.19832 4.73324 2.12772 5.49971H5.00022C5.01278 5.46534 5.02699 5.43172 5.04306 5.39911Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M6.3533 2.80791V4.87138C6.38865 4.88357 6.42322 4.89741 6.45675 4.91301L8.48765 2.93805C7.97508 2.52348 7.3579 2.24158 6.70385 2.12448L6.3533 2.80791Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M7.67584 0.229584L7.0301 1.48853C7.86457 1.67578 8.63892 2.09043 9.24909 2.68376C11.0447 4.43042 11.0451 7.25609 9.24914 9.00317C7.45301 10.7493 4.54733 10.7499 2.75069 9.00326C0.955127 7.25658 0.954538 4.43092 2.75062 2.6838C3.35483 2.09646 4.12032 1.68396 4.94503 1.49417L4.27818 0.242485C0.0391544 1.40288 -1.50863 6.87705 1.75094 9.9754C3.98763 12.2424 8.01217 12.2423 10.2488 9.9754C13.5221 6.86236 11.9468 1.36486 7.67584 0.229584Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M8.98777 3.42392L6.95663 5.39911C6.97271 5.43172 6.98691 5.46534 6.99945 5.49971H9.87195C9.80135 4.73326 9.49528 4.01463 8.98777 3.42392Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M5.64627 2.81073L5.28201 2.12698C4.63345 2.24548 4.0211 2.52651 3.51199 2.93812L5.54285 4.91304C5.57638 4.89741 5.61095 4.88359 5.64629 4.8714V2.81073H5.64627Z"
                      fill="#E1E1E1"
                    />
                    <path
                      d="M5.99986 6.18726C6.19476 6.18726 6.35333 6.03307 6.35333 5.84353C6.33556 5.38816 5.66409 5.38827 5.64639 5.84353C5.64639 6.03307 5.80496 6.18726 5.99986 6.18726Z"
                      fill="#E1E1E1"
                    />
                  </svg>
                  <span>Roulette</span>
        ...
        <div className={styles.topLeaders}>
          <h3>Top-Winnings</h3>
          <h4 className={styles.topLeaders__desc}>Top-10 winners </h4>
          <div className={styles.bannerLeaders}>
            ...
            <div className={styles.winners}>
              <div className={styles.winners__header}>
                <div>
                  <img src="/winners_user.svg" alt="winners_user" />
                  <p>User</p>
                </div>
                <div>
                  <img src="/winners_crown.svg" alt="winners_crown" />
                  <p>Win</p>
                </div>
              </div>

              <ul className={styles.winners__list}>
                {leadersList.length > 0 ?leadersList.map((el, index) => {
                  return (
                    <li key={index} className={styles.winners__list__item}>
                      <div>
                        <img src="/social_icon.svg" alt="social_icon" />
                        {el.nickname}
                      </div>
                      <div>{el.total_winnings} ₹</div>
                    </li>
                  );
                }) : <p className={styles.winners__list__empty}>No winners</p>}
              </ul>
            </div>
          </div>
        </div>
        <p className={styles.footer__decription}>
          The casino is legal, has a certificate, registered in Cyprus under number 453728992354
        </p>
