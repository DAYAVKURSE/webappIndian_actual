        ...
        .then((data) => {
          if (Array.isArray(data)) {
            ...
            const earned = data.reduce(
              (total, referral) => total + (referral.EarnedAmount || 0),
              0
            );
    ...
    <div className={styles.profile}>
      ...
      <div className={styles.referralSection}>
        ...
        <p className={styles.referDescription}>
          Share your link with friends, family, or on social media. When someone
          signs up and makes a deposit using your link, youll get 20% of their
          deposit
        </p>
